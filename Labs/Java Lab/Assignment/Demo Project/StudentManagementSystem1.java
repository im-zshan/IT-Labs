...
class StudentManagementSystem1 extends JFrame 
{
    ...
    private JButton addButton, viewButton, searchButton, updateButton, deleteButton, statisticsButton;
    ...
    private void addStudent() {
        ...
        for (int i = 0; i < students.size(); i++) 
        {
            ...
            if (student.getRollNumber().equalsIgnoreCase(rollNumber) && student.getCourse().equalsIgnoreCase(course)) 
            {
            ...
            if (student.getRollNumber().equalsIgnoreCase(rollNumber) && !(student.getName().equalsIgnoreCase(name))) 
            {
        ...
        tableModel.addRow(new Object[]{name, rollNumber, course, marks});
